...
<ul class="menu">
    ...
    <div class="row">
      <h3><i class="fa-solid fa-chart-simple" style="color: #ffc800;"></i> Edit Produk</h3><hr>
          <!-- Area Chart -->
          <div class="col-md-12">
                                ...
                                <!-- <div class="form-responsive"> -->
                                    <form class="user" action="proses_update.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="detail" name="detail"  value="<?php echo $row['product_code']; ?>"  required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
