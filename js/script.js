window.addEventListener("DOMContentLoaded", () => {
  ...
  const dataProduct = [
    {
      image: "itama1.png",
      name: "Madu Itama 125 gr",
      // price: 60000,
      description:
        "Madu yang dihasilkan dari lebah tak bersengat spesies Trigona, rasa madu cenderung lebih asam dan kaya akan propolis.",
    },
    {
      image: "itama2.png",
      name: "Madu Itama 300 gr",
      // price: 135000,
      description:
        "Madu yang dihasilkan dari lebah tak bersengat spesies Trigona, rasa madu cenderung lebih asam dan kaya akan propolis.",
    },
    {
      image: "mellifera1.png",
      name: "Madu Manis 125 gr",
      // price: 25000,
      description:
        "Madu murni tanpa campuran apapun dengan rasa manis dan kental baik bagi kesehatan ataupun pengganti gula.",
    },
  ];
  /* ========== DATA PRODUCT END ========== */
